...
from views import index, about, contests, connect, contact, friend, signup, campaigns, campone, camptwo, campthree, ts, reffered, feedback, error, sweetthanks
